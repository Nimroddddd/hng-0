This project was built using node.js and serves as a simple API to provide the current time, along with my email and the link to this github repository.
